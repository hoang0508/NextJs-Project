...
export const RewardsAmount: React.FC<IRewardsAmountProps> = ({
  amountToClaim,
}) => {
  ...
  return (
    <Grid container alignItems="center" className={classes.root} wrap="nowrap">
      <Typography className={classes.text}>
        <AnimatedNumber
          value={printBN(
            amountToClaim.val || new BN(0),
            amountToClaim.scale || 0
          )}
          duration={300}
        ...
        />
        {+printBN(amountToClaim.val || new BN(0), amountToClaim.scale || 0) >=
        10000
          ? "K "
          : +printBN(
              amountToClaim.val || new BN(0),
