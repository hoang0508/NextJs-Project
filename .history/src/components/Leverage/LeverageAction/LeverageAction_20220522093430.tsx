...
const LeverageAction: React.FC<IProps> = ({
  actionContents,
  onClickSubmitButton,
  onClickResetButton,
  minCRatio,
              ...
              hint={
                <>
                  ...
                  <Typography
                    ...
                    style={{ marginBottom: 10 }}
                  >
                    Leverage allows you to operate with higher capital than you
                    have, after paying a collateral deposit. The value of the
                    collateral depends on you and is the basis for calculating
