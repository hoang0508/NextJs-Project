...
import AnimatedNumber from "@components/AnimatedNumber/index.d";
      ...
      <Grid>
        <Grid>
          <Grid container direction="row" className={classes.headerRow}>
            <Grid
              classes={{
                root: classNames(classes.rootHeader, classes.symbolColumn),
              }}
            >
              Coll./Borr.
            </Grid>
            {page === "vault" ? (
              <Grid
                classes={{
                  root: classNames(classes.rootHeader, classes.typeColumn),
                }}
              >
                Type
              </Grid>
            ...
            <Grid
              classes={{
                root: classNames(classes.rootHeader, classes.amountColumn),
              }}
            >
            ...
            {page === "vault" ? (
              <Grid
                classes={{
                  root: classNames(classes.rootHeader, classes.cRatioColumn),
                }}
              >
                C-Ratio
              </Grid>
              ...
              <>
                <Hidden smUp>
                  <Grid
                    classes={{
                      root: classNames(classes.rootHeader, classes.LeverColumn),
                    }}
                  >
                    Lever
                  </Grid>
            ...
            <Grid
              classes={{
                root: classNames(classes.rootHeader, classes.liquidationColumn),
              }}
            >
            ...
            {page === "leverage" ? (
              <Grid
                classes={{
                  root: classNames(classes.rootHeader, classes.buttonColumn),
                }}
              >
                Close
              </Grid>
          ...
          {userVaults.map((element, index) => (
            ...
            >
              <Hidden xsDown>
                <Grid
                  classes={{
                    root: classNames(classes.rootCell, classes.symbolColumn),
                  }}
                  style={{ display: "flex" }}
                >
              ...
              <Grid
                classes={{
                  root: classNames(classes.rootCell, classes.amountColumn),
                }}
              >
                <Tooltip
                  classes={{ tooltip: classes.tooltipNumber }}
                  title={`${printBN(
                    element.deposited.val,
                    element.deposited.scale
                  )} ${element.collateral}`}
              ...
              >
                <Tooltip
                  classes={{ tooltip: classes.tooltipNumber }}
                  title={`${printBN(
                    element.currentDebt.val,
                    element.currentDebt.scale
                  )} ${element.borrowed}`}
                  placement="bottom-start"
                >
                  <Grid>
              ...
              {page === "vault" ? (
                <Grid
                  classes={{
                    root: classNames(classes.rootCell, classes.cRatioColumn),
                  }}
                  style={{
                    color:
                      element.cRatio === "NaN" ||
                      Number(element.cRatio) >= element.minCRatio
                        ? colors.green.button
                        : colors.red.error,
                  }}
                >
                ...
                <Grid
                  classes={{
                    root: classNames(classes.rootCell, classes.LeverColumn),
                  }}
                >
                  <Grid container direction="row" alignItems="center">
              ...
              <Grid
                classes={{
                  root: classNames(classes.rootCell, classes.liquidationColumn),
                }}
              >
                {page === "leverage" && element.collateral === "xUSD" ? (
                  <Tooltip
                    classes={{ tooltip: classes.tooltipNumber }}
                    title={`${Number(element.liquidationShortPrice).toFixed(
                      6
                    )} $`}
                    placement="bottom-start"
                  >
                    ...
                    >
                      <Grid>
                        ...
                        <AnimatedNumber
                          ...
                          duration={300}
                        />
                        {showPrefix(Number(element.maxBorrow))}{" "}
                        {element.borrowed} left
                      </Grid>
                    </Tooltip>
                  </Grid>
                </Hidden>
              ...
              {page === "leverage" ? (
                <Grid
                  classes={{
                    root: classNames(classes.rootCell, classes.buttonColumn),
                  }}
                >
                  <OutlinedButton
                    name={"Close"}
