...
const WrappedBorrow: React.FC<IProp> = ({
  pairs,
  sending,
  hasError,
  userVaults,
    ...
    borrow: (
      <ActionBorrow
        ...
        liquidationPriceFrom={
          liquidationPriceFrom > 0 ? liquidationPriceFrom : 0
        }
        ...
        {userVaults.length !== 0 ? (
          <BorrowTable
            ...
            active={{
              collateral:
                pairIndex !== null
                  ? pairs[pairIndex].collateralData.symbol
                  : null,
              synthetic:
                pairIndex !== null
                  ? pairs[pairIndex].syntheticData.symbol
                  : null,
            }}
      ...
      <Grid className={classes.borrowInfoGrid}>
        {pairs.length !== 0 && pairIndex !== null ? (
          <BorrowInfo
            ...
            limit={Number(
              printBN(
                pairs[pairIndex].maxBorrow.val.sub(
                  pairs[pairIndex].mintAmount.val
                ),
