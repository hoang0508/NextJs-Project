...
// import { BorrowedPair } from './WrappedBorrow'
import WrappedBorrow from "./WrappedBorrow";
// import BorrowedPair from "./WrappedBorrow";
...
import { BorrowedPair } from "@components/Leverage/WrappedLeverage/WrappedLeverage";
...
storiesOf("borrow/wrappedborrow", module).add("default", () =>
  React.createElement(() => {
    ...
    const collaterals = "WSOL ETH".split(" ").map((i): {
