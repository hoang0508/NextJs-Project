      ...
      <Grid container item direction="column" className={classes.dataWrapper}>
        ...
        <Grid container item className={classes.descWrapper}>
          ...
          <Typography className={classes.descText}>
            Swapline is a more straightforward way to get synthetic tokens. It
            exists to keep the price of each of the synthetic tokens close to
            their original counterparts. Tokens can be swapped from collateral
            to synthetic as long as the total swapped amount is below the
            swapline limit. They can also be swapped back from synthetic to
            collateral, as long as there are enough tokens in collateral reserve
            (balance).
          </Typography>
        </Grid>
      </Grid>
