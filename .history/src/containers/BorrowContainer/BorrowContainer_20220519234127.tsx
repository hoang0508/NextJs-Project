import {
  BorrowedPair,
  WrappedBorrow,
} from "@components/Borrow/WrappedBorrow/WrappedBorrow";
...
const BorrowContainer = ({ pairs, userVaults }: IProp) => {
    ...
    <Grid className={classes.root}>
      ...
      <WrappedBorrow
        ...
        setActualPair={(synthetic, collateral, vaultType) => {
          dispatch(
            actions.setActualVaultSwap({ collateral, synthetic, vaultType })
          );
        }}
