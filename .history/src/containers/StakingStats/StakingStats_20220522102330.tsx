    ...
    <>
      <Grid className={classes.statsTile} item xs={12} sm={6} md={4} lg={4}>
        <ValueCard
          ...
          hint={
            <>
              <Image src={Star} alt="" className={classes.tooltipIcon} />
              <Typography
              ...
              <p style={{ margin: 0, color: colors.navy.lightGrey }}>
                {" "}
                Your current USD denominated value of all deposited collaterals.
                Prices of collaterals are provided by decentralized Pyth
                oracles.
              </p>
            </>
          }
      ...
      <Grid className={classes.statsTile} item xs={12} sm={6} md={8} lg={8}>
        <ProgressCard
          ...
          hint={
            <>
              <Image src={Percent} alt="" className={classes.tooltipIcon} />
              <Typography className={classes.tooltipTitle}>
                Debt status
              </Typography>
              <p style={{ marginBlock: 10, color: colors.navy.lightGrey }}>
                Current value of your debt proportionally to the global debt.
                Max borrow represents mint threshold. Value at the end of the
                bar is your liquidation threshold - if your debt increases
                beyond this value, your position can be liquidated.
              </p>
              <p style={{ marginBlock: 10, color: colors.navy.lightGrey }}>
              ...
              <b>
                Interest rate:{" "}
                {Number(printBN(interestRate.val, interestRate.scale)) * 100}%
              </b>
            </>
          }
