        ...
        <Grid item className={classes.exchange}>
          ...
          <Grid container className={classes.row}>
            <Grid item className={classes.plotWrapper}>
              <SwapInfo
                syntheticSymbol={
                  pairs[pairIndex === null ? 0 : pairIndex]?.syntheticData
                    ?.symbol ?? ""
                }
                collateralSymbol={
                  pairs[pairIndex === null ? 0 : pairIndex]?.collateralData
                    ?.symbol ?? ""
                }
                fee={
                  +printDecimal(
                    pairs[pairIndex === null ? 0 : pairIndex]?.fee ??
                      decimalZero
                  )
                }
                balance={
                  +printDecimal(
                    pairs?.length
                      ? {
                          val: pairs[
                            pairIndex === null ? 0 : pairIndex
                          ].balance.val.sub(
                            pairs[pairIndex === null ? 0 : pairIndex]
                              .accumulatedFee.val
                          ),
                          scale:
                            pairs[pairIndex === null ? 0 : pairIndex].balance
                              .scale,
                        }
                      : decimalZero
                  )
                ...
                limit={
                  +printDecimal(
                    pairs[pairIndex === null ? 0 : pairIndex]?.limit ??
                      decimalZero
                  )
                }
              />
